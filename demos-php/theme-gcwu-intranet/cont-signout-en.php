...
$_PAGE['title_en'] = "Content page - Sign out - GC Web Usability Intranet theme - Working examples - Web Experience Toolkit&#160;(WET)";
$_PAGE['short_title_en'] = "Content page - Sign out - GC Web Usability Intranet theme";

$_PAGE['signout'] = "1";
$_SITE['wb_signout_file_en'] = "cont-signin-en.php";
