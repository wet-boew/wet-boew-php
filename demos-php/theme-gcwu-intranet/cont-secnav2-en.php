...
$_PAGE['left_menu_gauche'] = $_PAGE_PATH_ ."/menu-left-gauche/secnav2-en.php";

$_PAGE['title_en'] = "Content page - Secondary menu 2 - GC Web Usability Intranet theme - Working examples - Web Experience Toolkit&#160;(WET)";
$_PAGE['short_title_en'] = "Content page - Secondary menu 2";
