...
$_PAGE['title_en'] = "Server message page - Bilingual (eng-fr) - GC Web Usability theme - Web Experience Toolkit (WET)";
$_PAGE['title_fr'] = "Page de message du serveur - Bilingue (eng-fr) - Thème de la facilité d'emploi Web GC - Exemples pratiques - Boîte à outils de l'expérience Web (BOEW)";
