...
echo '<h2>' . $_UNKNOWN['gcwu_gcnavbar_' . $_PAGE['lang1']] . '</h2>';
...
$SIG_IMG_TITLE = $_UNKNOWN['gcwu_sig_' . $_PAGE['lang1']];
...
echo '<a ' .$TARGET .'rel="external" href="' . $_UNKNOWN['gcwu_gcnb1_href_' . $_PAGE['lang1']] .'">';
echo $_UNKNOWN['gcwu_gcnb1_text_' . $_PAGE['lang1']];
echo "</a></li>";


echo '<li id="gcwu-gcnb2">';
echo '<a ' .$TARGET .'rel="external" href="' . $_UNKNOWN['gcwu_gcnb2_href_' . $_PAGE['lang1']] .'">';
echo $_UNKNOWN['gcwu_gcnb2_text_' . $_PAGE['lang1']];
echo "</a></li>";

echo '<li id="gcwu-gcnb3">';
echo '<a ' .$TARGET .'rel="external" href="' . $_UNKNOWN['gcwu_gcnb3_href_' . $_PAGE['lang1']] .'">';
echo $_UNKNOWN['gcwu_gcnb3_text_' . $_PAGE['lang1']];
echo "</a></li>";
...
if (!isset($_PAGE['nolang']) || (isset($_PAGE['nolang']) && $_PAGE['nolang']=='')) { 
	...
	echo '<a href="' .$_UNKNOWN['wb_cmblang_href_' . $_PAGE['lang1']];
	echo '" lang="' .$_UNKNOWN['gcwu_langalt_' . $_PAGE['lang1']];
	echo '">' . $_UNKNOWN['wb_cmblang_text_' . $_PAGE['lang1']]; 
	echo '</a></li>';
}
...
$CAN_IMG_TITLE = $_UNKNOWN['gcwu_wmms_' . $_PAGE['lang1']];
...
echo '<a href="' .$_UNKNOWN['gcwu_banner_href_' . $_PAGE['lang1']] .'">' . $_UNKNOWN['wb_site_title_' . $_PAGE['lang1']].'</a></p></div>';
...
if (!isset($_PAGE['nosearch']) || (isset($_PAGE['nosearch']) && $_PAGE['nosearch'] != '')) { 
	echo '<section role="search"><div id="gcwu-srchbx"><h2>'.$_UNKNOWN['wb_search_' . $_PAGE['lang1']] .'</h2>';
	if ($_UNKNOWN['wb_search_file'] != '') { 
		include $_SERVER['DOCUMENT_ROOT'] . $_UNKNOWN['wb_search_file']; 
	}
	echo '</div></section>';
}
...
if ((!isset($_PAGE['nositemenu']) || (isset($_PAGE['nositemenu']) && $_PAGE['nositemenu'] != '1')) ||
	...
	//Mega Menu
	if (!isset($_PAGE['nositemenu']) || (isset($_PAGE['nositemenu']) && $_PAGE['nositemenu'] != '1')) { 
		echo '<div id="gcwu-psnb"><h2>'.$_UNKNOWN['wb_sitenav_' . $_PAGE['lang1']].'</h2>';
		echo '<div id="gcwu-psnb-in">';
		
		include $_SERVER['DOCUMENT_ROOT'] . $_UNKNOWN['gcwu_menuprim'] . "-" . "" . $_PAGE['lang1'] . ".php";
	...
	if (!isset($_PAGE['bcrumb_hide']) || (isset($_PAGE['bcrumb_hide']) && $_PAGE['bcrumb_hide'] != '1')) { 
		echo '<div id="gcwu-bc"><h2>'.$_UNKNOWN['wb_bcrumb_' . $_PAGE['lang1']] .'</h2>';
