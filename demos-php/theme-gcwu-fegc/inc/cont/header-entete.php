...
<div id="gcwu-sig"><div id="gcwu-sig-in"><object data="/build/theme-gcwu-fegc/images/<?php echo $_UNKNOWN['gc_sig_image']; ?>-<?php echo $_PAGE['lang1']; ?>.svg" role="img" tabindex="-1" aria-label="<?php echo $_UNKNOWN['gc_sig_' . $_PAGE['lang1']]; ?>" type="image/svg+xml"><img src="/build/theme-gcwu-fegc/images/<?php echo $_UNKNOWN['gc_sig_image']; ?>-<?php echo $_PAGE['lang1']; ?>.png" alt="<?php echo $_UNKNOWN['gc_sig_' . $_PAGE['lang1']]; ?>" /></object></div></div>
<ul>
...
<div id="gcwu-wmms"><div id="gcwu-wmms-in"><object data="/build/theme-gcwu-fegc/images/wmms.svg" role="img" tabindex="-1" aria-label="<?php echo $_UNKNOWN['gc_wmms_' . $_PAGE['lang1']]; ?>" type="image/svg+xml"><img src="/build/theme-gcwu-fegc/images/wmms.png" alt="<?php echo $_UNKNOWN['gc_wmms_' . $_PAGE['lang1']]; ?>" /></object></div></div>
