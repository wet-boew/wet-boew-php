...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "Modèle pour applications - Fermer la session - Thème de la facilité d'emploi Web GC - Exemples pratiques - Boîte à outils de l'expérience Web (BOEW)";
...
<li class="settings"><a class="button button-accent" href="#">Paramètres du compte</a></li>
<li class="session"><a class="button button-accent" href="application-signin-fra.html">Fermer la session</a></li>
</ul>
</aside></div>
