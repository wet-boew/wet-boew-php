...
$_PAGE['title_' . $_PAGE['lang1']] = "Page de contenu - ".$theme_title[$_SITE['wb_theme']]." - Boîte à outils de l'expérience Web";
$_PAGE['issued'] = "YYYY-MM-DD";
$_PAGE['modified'] = "YYYY-MM-DD";

//Optional variables
$_PAGE['short_title_' .$_PAGE['lang1']] = "Page de contenu - ".$theme_title[$_SITE['wb_theme']];
