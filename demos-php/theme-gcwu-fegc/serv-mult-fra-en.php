...
$_PAGE['title_en'] = "Server message page - Multilingual (eng-fr) - GC Web Usability theme - Web Experience Toolkit (WET)";
$_PAGE['title_fr'] = "Page de message du serveur - Multilingue (eng-fr) - Thème de la facilité d'emploi Web GC - Exemples pratiques - Boîte à outils de l'expérience Web (BOEW)";
