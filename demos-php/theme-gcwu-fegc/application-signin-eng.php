...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "Application template - Sign in - GC Web Usability theme - PHP variant - Working examples - Web Experience Toolkit&#160;(WET)";
...
<li class="session"><a class="button button-accent" href="application-signout-eng.html">Sign in</a></li>
</ul>
</aside></div>
