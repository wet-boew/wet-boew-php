...
$_PAGE['title_' . $_PAGE['lang1']] = "Content page - No search or language selection link - ".$theme_title[$_SITE['wb_theme']]." - Web Experience Toolkit";
$_PAGE['issued'] = "YYYY-MM-DD";
$_PAGE['modified'] = "YYYY-MM-DD";

//Optional variables
$_PAGE['short_title_' .$_PAGE['lang1']] = "Content page - No search or language selection link - ".$theme_title[$_SITE['wb_theme']];
