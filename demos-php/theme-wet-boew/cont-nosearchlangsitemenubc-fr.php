...
$_PAGE['title_' . $_PAGE['lang1']] = "Page de contenu - Sans recherche, lien de sélection de la langue, menu du site ou fil d'Ariane - Thème de la BOEW - Exemples pratiques - Boîte à outils de l'expérience Web&#160;(BOEW)";
$_PAGE['short_title_' . $_PAGE['lang1']] = "Page de contenu - Sans recherche, lien de sélection de la langue, menu du site ou fil d'Ariane";
...
<!-- Main content start -->
<?php 
include "includes/sample-cont-fr.php";
?>
<!-- MainContentEnd -->
<?php 
