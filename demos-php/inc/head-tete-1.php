...
<?php if ($_PAGE['lang2'] != '') { ?><meta name="dcterms.title" lang="<?php echo $_UNKNOWN['wb_meta_' . $_PAGE['lang2']]; ?>" content="<?php echo $_PAGE['title_' . $_PAGE['lang2']]; ?>" /><?php } ?>
...
<?php if ($_PAGE['lang2'] != '') { ?><meta name="dcterms.language" lang="<?php echo $_UNKNOWN['wb_meta_' . $_PAGE['lang2']]; ?>" title="ISO639-2" content="<?php echo $_PAGE['lang2']; ?>" /><?php } ?>
