...
<?php if ($_PAGE['lang2'] != '') { ?><h1 id="wb-cont"><?php echo $_PAGE['title_' . $_PAGE['lang1']]; ?> / <span lang="<?php echo $_UNKNOWN['wb_meta_' . $_PAGE['lang2']]; ?>"><?php echo $_PAGE['title_' . $_PAGE['lang2']]; ?></span></h1>
