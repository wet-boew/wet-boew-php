...
$_PAGE['title_' . $_PAGE['lang1']] = "Content page - No search, language toggle, site menu or breadcrumb trail - WET theme - Web Experience Toolkit";
$_PAGE['issued'] = "YYYY-MM-DD";
$_PAGE['modified'] = "YYYY-MM-DD";

//Optional variables
$_PAGE['short_title_' .$_PAGE['lang1']] = "Content page - No search, language toggle, site menu or breadcrumb trail - WET theme";
