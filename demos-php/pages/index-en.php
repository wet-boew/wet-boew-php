...
$_PAGE['title_' . $_PAGE['lang1']] = $_SITE['theme_list_' . $_PAGE['lang1']][$_SITE['wb_theme']] . " - Web Experience Toolkit";
...
<!-- Main content start -->
<?php include $_SERVER['DOCUMENT_ROOT'] . $_SITE['wb_website_root'] . "/pages/includes/index-en.php"; ?>
<!-- MainContentEnd -->
