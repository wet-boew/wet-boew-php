...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "3&nbsp;colonnes - Thème général - XHTML 1.0 Strict - Boîte à outils de l'expérience Web (BOEW)";
...
<hr />
<dl id="cn-doc-dates">
<dt>Date de modification&#160;:</dt><dd><span><?php echo $_PAGE['modified']; ?></span></dd>
</dl>
<?php include $_SERVER['DOCUMENT_ROOT'] . "/inc/centre-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-left-gauche/xhtml/exmple-xhtml-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-right-droite/xhtml/exmple-xhtml-fra.php";
