...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "3 column layout - General Theme - XHTML 1.0 Strict - Web Experience Toolkit (WET)";
...
<hr />
<dl id="cn-doc-dates">
<dt>Date Modified:</dt><dd><span><?php echo $_PAGE['modified']; ?></span></dd>
</dl>

<?php include $_SERVER['DOCUMENT_ROOT'] . "/inc/centre-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-left-gauche/xhtml/exmple-xhtml-eng.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-right-droite/xhtml/exmple-xhtml-eng.php";
