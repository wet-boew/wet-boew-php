...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "3 column layout - General Theme - HTML5 - Web Experience Toolkit (WET)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-left-gauche/exmple-eng.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-right-droite/exmple-eng.php";
