...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "3&nbsp;colonnes - Thème général - HTML5 - Boîte à outils de l'expérience Web (BOEW)";
...
<section><h2>L'en-tête de niveau&#160;2 (h2)</h2>

	<div class="cn-toppage"><a href="#cn-tphp" title="Retourner au haut de la page">Haut de la page</a></div>
	<section><h3>L'en-tête de niveau&#160;3 (h3)</h3>

		<div class="cn-toppage"><a href="#cn-tphp" title="Retourner au haut de la page">Haut de la page</a></div>
		<section><h4>L'en-tête de niveau&#160;4 (h4)</h4>

			<div class="cn-toppage"><a href="#cn-tphp" title="Retourner au haut de la page">Haut de la page</a></div>
			<section><h5>L'en-tête de niveau&#160;5 (h5)</h5>

				<div class="cn-toppage"><a href="#cn-tphp" title="Retourner au haut de la page">Haut de la page</a></div>
				<section><h6>L'en-tête de niveau&#160;6 (h6)</h6>
...
<dt>Date de modification&#160;:</dt><dd><span><time pubdate="pubdate"><?php echo $_PAGE['modified']; ?></time></span></dd>
</dl>
<?php include $_SERVER['DOCUMENT_ROOT'] . "/inc/centre-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-left-gauche/exmple-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-general/php/menu-right-droite/exmple-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-2.php";
