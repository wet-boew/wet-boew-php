...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['lang2'] = "eng";
$_PAGE['title_fra'] = "Titre du message - Page de message du serveur (fra-eng) - Thème NSI 2.0 - HTML5 - Boîte à outils de l'expérience Web (BOEW)";
$_PAGE['title_eng'] = "Message title - Server message page (fra-eng) - CLF 2.0 Theme - HTML5 - Web Experience Toolkit (WET)";
...
<div id="cn-left-msg"><section><h2>Titre du message (h2)</h2>
...
<div id="cn-right-msg" lang="en"><section><h2>Message title (h2)</h2>
<p>Message message message message message message message message message message message message message message message message message message message message.</p>
</section></div>
