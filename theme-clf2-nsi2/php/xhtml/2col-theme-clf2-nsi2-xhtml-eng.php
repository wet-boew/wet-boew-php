...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "2 column layout - CLF 2.0 Theme - XHTML 1.0 Strict - Web Experience Toolkit (WET)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/xhtml/exmple-xhtml-eng.php";
