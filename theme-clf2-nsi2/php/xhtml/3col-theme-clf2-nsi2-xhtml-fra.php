...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "3&nbsp;colonnes - Thème NSI 2.0 - XHTML 1.0 Strict - Boîte à outils de l'expérience Web (BOEW)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/inc/cont/header-entete.php";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/xhtml/exmple-xhtml-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/xhtml/pd-dp-xhtml-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-right-droite/xhtml/exmple-xhtml-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/inc/cont/trail-arr.php"; ?>
</body>
</html>