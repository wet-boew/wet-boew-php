...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['lang2'] = "eng";
$_PAGE['title_fra'] = "Titre du message - Page de message du serveur (fra-eng) - Thème NSI 2.0 - XHTML 1.0 Strict - Boîte à outils de l'expérience Web (BOEW)";
$_PAGE['title_eng'] = "Message title - Server message page (fra-eng) - CLF 2.0 Theme - XHTML 1.0 Strict - Web Experience Toolkit (WET)";
...
<div id="cn-left-msg"><h2>Titre du message (h2)</h2>
...
<div id="cn-right-msg" lang="en" xml:lang="en"><h2>Message title (h2)</h2>
<p>Message message message message message message message message message message message message message message message message message message message message.</p>
</div>
