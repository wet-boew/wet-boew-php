...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "2&nbsp;colonnes - Thème NSI 2.0 - HTML5 - Boîte à outils de l'expérience Web (BOEW)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/exmple-fra.php";
