...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "3 column layout - CLF 2.0 Theme - HTML5 - Web Experience Toolkit (WET)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/exmple-eng.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-left-gauche/pd-dp-eng.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-clf2-nsi2/php/menu-right-droite/exmple-eng.php";
