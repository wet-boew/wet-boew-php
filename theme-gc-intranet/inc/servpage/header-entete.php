...
<div id="fip-title" class="span-8">
	<div id="cn-sig" class="span-4 row-start"><div id="cn-sig-inner"><div id="fip-pcim-sig-<?php echo $_PAGE['lang1']; ?>" title="<?php echo $_TEMPLATE['sig_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['sig_' . $_PAGE['lang2']]; ?>"><img src="/<?php echo $_TEMPLATE['fip_theme_folder']; ?>/fip-pcim/images/<?php echo $_TEMPLATE['sig_image']; ?>-<?php echo $_PAGE['lang1']; ?>.gif" class="image-actual" width="214" height="20" alt="<?php echo $_TEMPLATE['sig_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['sig_' . $_PAGE['lang2']]; ?>" /></div></div></div>
	<div id="cn-wmms" class="span-4 row-end"><div id="cn-wmms-inner"><div id="fip-pcim-wmms" title="<?php echo $_TEMPLATE['wmms_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['wmms_' . $_PAGE['lang2']]; ?>"><img src="/theme-gc-intranet/fip-pcim/images/wmms.gif" class="image-actual" width="126" height="30"  alt="<?php echo $_TEMPLATE['wmms_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['wmms_' . $_PAGE['lang2']]; ?>" /></div></div></div>
	<div class="clear"></div>
