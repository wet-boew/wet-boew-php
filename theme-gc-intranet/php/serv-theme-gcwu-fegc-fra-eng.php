...
<?php include $_SERVER['DOCUMENT_ROOT'] . "/theme-gc-intranet/inc/servpage/css.php"; ?>
</head>
<body>
<?php include $_SERVER['DOCUMENT_ROOT'] . "/inc/1col.php";
include $_SERVER['DOCUMENT_ROOT'] . "/theme-gc-intranet/inc/servpage/header-entete.php";
...
<ul>
<li><a href="home-accueil-megamenu-theme-gc-intranet-fra.html">Accueil</a></li>
...
<p>Message message message message message message message message message message message message message message message message message message message message.</p>
<ul>
<li><a href="home-accueil-megamenu-theme-gc-intranet-eng.html">Home</a></li>
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-gc-intranet/inc/servpage/trail-arr.php"; ?>
</body>
</html>