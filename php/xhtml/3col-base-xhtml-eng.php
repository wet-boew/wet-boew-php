...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "3 column layout - Base - Web Experience Toolkit (WET)";
...
include $_SERVER['DOCUMENT_ROOT'] . "/php/menu-left-gauche/xhtml/exmple-xhtml-eng.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/php/menu-right-droite/xhtml/exmple-xhtml-eng.php";
