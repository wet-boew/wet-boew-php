...
<?php $_PAGE['lang1'] = "fra";
$_PAGE['title_fra'] = "3&nbsp;colonnes - Base - Boîte à outils de l'expérience Web (BOEW)";
...
<p>Contient normalement le contenu principal de la page.</p>

<?php include $_SERVER['DOCUMENT_ROOT'] . "/inc/centre-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/php/menu-left-gauche/xhtml/exmple-xhtml-fra.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/left-gauche-2.php";
include $_SERVER['DOCUMENT_ROOT'] . "/inc/right-droite-1.php";
include $_SERVER['DOCUMENT_ROOT'] . "/php/menu-right-droite/xhtml/exmple-xhtml-fra.php";
