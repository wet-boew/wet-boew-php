...
<?php $_PAGE['lang1'] = "eng";
$_PAGE['title_eng'] = "2 column - Mega menu - GC Web Usability theme";
...
include $_SERVER['DOCUMENT_ROOT'] . "/theme-gcwu-fegc/php/menu-left-gauche/xhtml/exmple-xhtml-eng.php";
