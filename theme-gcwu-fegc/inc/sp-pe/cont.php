...
<div id="cn-wmms" class="span-2 margin-bottom-none"><div id="cn-wmms-inner"><div id="fip-pcim-wmms" title="<?php echo $_TEMPLATE['wmms_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['wmms_' . $_PAGE['lang2']]; ?>"><img src="/theme-gcwu-fegc/fip-pcim/images/wmms.gif" width="126" height="30"  alt="<?php echo $_TEMPLATE['wmms_' . $_PAGE['lang1']]; ?> / <?php echo $_TEMPLATE['wmms_' . $_PAGE['lang2']]; ?>" /></div></div></div>
<div class="clear"></div>
<?php if ($_PAGE['lang3'] != '') { ?>
<div class="clear"></div>
